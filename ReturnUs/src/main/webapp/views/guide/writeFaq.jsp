					...
					<div style="height: 100%; padding: 0px 70px 0px 70px">
						...
						<div id="big" class="card">
							...
							<div id="sm" class="card">
								<form id="faqform" action="writefaq" method="post">   									
									<input id="FaqTitle" name="faqTitle" style="margin-bottom: 2%;">
									<div id="editor"></div>
									<input type="hidden" name="faqContent" id="faqContent">
								<button type="submit" class="button" style="float: right; margin-top:2%;">게시글 작성</button>
								</form>	
							</div>
						</div>
					</div>
