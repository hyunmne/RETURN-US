							...
							<div id="sm" class="card">
		                        ...
		                        <div id="pointContent">
									...
									<div id="rejectionDiv" class="col-5">
			                        	<c:choose>
			                        		<c:when test="${empty colDetail.colRejection && colDetail.colStatus eq '수거완료' }">
												<div id="title">
						                            <i class="fas fa-grip-lines-vertical"></i>&nbsp;&nbsp;포인트 지급
						                        </div>
												<textarea name="colRejection" readonly>포인트가 정상 지급되었습니다</textarea>
			                        		</c:when>
			                        		<c:when test="${empty colDetail.colRejection && colDetail.colStatus ne '수거완료' }">
												<div id="title">
						                            <i class="fas fa-grip-lines-vertical"></i>&nbsp;&nbsp;포인트 지급
						                        </div>
									...
									<div id="btnDiv">
										<c:if test="${colDetail.colStatus eq '수거준비중'}">
									  		<button id="modifyBtn" class="btnStyle" onclick="location.href='collection-modify?colNum=${colDetail.colNum}'">수정</button>
									  	</c:if>										
										<button class="btnStyle" onclick="location.href='my-collection'">목록으로</button>
									</div>
		                        </div>
							</div>
						</div>
